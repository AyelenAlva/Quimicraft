...
import img1 from './assets/css/img/ciencia.avif'; // Cambia la ruta a la imagen correspondiente
import img2 from './assets/css/img/ciencia.avif'; // Cambia la ruta a la imagen correspondiente
import img3 from './assets/css/img/ciencia.avif'; // Cambia la ruta a la imagen correspondiente
import organicCompoundBanner from './assets/css/img/organico.png'; // Cambia la ruta a la imagen correspondiente
